/*Main UI code for EITC expiration interactive
By Nick Kasprak
CBPP*/
...
var calcInterface = {
	...
	addCommas: function(nStr) {
		//from http://stackoverflow.com/questions/6392102/add-commas-to-javascript-output
		nStr += '';
		var x = nStr.split('.');
		var x1 = x[0];
...
$(window).on("load",function() {		
	...
	$("#outputsWrapper .thirdChildTier span").qtip({content:{text:'Families with three or more children currently are eligible for a larger EITC than families with two children. If this provision expires, larger families would lose up to $672 of their EITC.'},style:{classes:'explanatoryTip',target:"mouse"},
			position:{at:"top left",my:"bottom right",target:"mouse",viewport:$(window)}});
